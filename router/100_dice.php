...
//
//     $app->session->set("gameRound",
// new Niko\DiceGame\GameRound\GameRound($players, $dices, $amountOfAI, $playerNick));
//     $app->session->set("histogram", new Niko\Histogram\Histogram());
//
...
//     }
//
//     if (count($gameRound->getHistogramSequence()) > 0) {
